...
import { FaUsers, FaHome, FaSignInAlt, FaSignOutAlt } from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    <div className={style.navbar}>
      ...
      {!isAuthenticated && <Link to="/"><FaHome />Home</Link>}
      {!isAuthenticated && <Link to="/login"><FaSignInAlt />Login</Link>}
      </nav>
    </div >
  );
};
